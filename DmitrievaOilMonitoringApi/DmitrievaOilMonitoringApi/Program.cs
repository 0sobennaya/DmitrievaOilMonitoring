using DmitrievaOilMonitoringApi;
...
builder.Services.AddDbContext<OilMonitoringApiContext>(o => o.UseNpgsql(builder.Configuration.GetConnectionString("DefaultConnection")));
